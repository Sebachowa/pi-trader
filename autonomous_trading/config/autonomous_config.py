...
def create_live_trading_config(autonomous_config: AutonomousSystemConfig) -> TradingNodeConfig:
    """Create Nautilus TradingNodeConfig from autonomous config."""
    ...
    return TradingNodeConfig.parse_obj(config_dict)